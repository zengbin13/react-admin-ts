  ...
  return (
    <div className={`${styles.root} p-4 sm:p-10 xl:p-24 `}>
      <div className="bg-[#ffffff30] backdrop-blur-md overflow-hidden flex-1 w-full flex flex-col rounded-xl  md:rounded-2xl  md:flex-row xl:max-w-[1200px]  xl:rounded-3xl">
        {/* 左侧介绍 */}
        <div className="flex-1 p-4" style={{ backgroundColor: colorPrimary }}>
          左侧
        </div>
        {/* 右侧表单 */}
        <div className="flex-1 flex justify-center">
          <div className="form-wrap flex flex-col mt-[10%] items-center p-4  max-w-[500px] min-w-[320px]">
            ...
            <h2 className="text-3xl">Hello Again!</h2>
            <p className=" text-gray-400 text-sm pt-2 pb-4">Lorem ipsum dolor sit amet consectetur quae hic odit quas! Animi ipsum sed vel laboriosam!</p>
            <LoginForm></LoginForm>
            <div className="text-gray-400 ">Don&apos;t have an account yet? Sign Up</div>
          </div>
        </div>
      </div>
    </div>
